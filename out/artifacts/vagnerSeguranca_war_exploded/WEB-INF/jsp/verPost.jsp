            ...
            <div class="col s12">
                <div class="card blue darken-1 z-depth-5">
                    <div class="card-content white-text">
                        <strong><span class="card-title"><c:out value="${post.tituloPost}"
                                                                escapeXml="true"/></span></strong>
                        <p><c:out value="${post.textoPost}" escapeXml="true"/></p>
                        <p>
                            <strong>Data: <c:out value="${post.dataPost}" escapeXml="true"/> </strong>
                        </p>
                        <p>
                            <strong>Autor: <c:out value="${post.usuario.nomeUsuario}" escapeXml="true"/></strong>
                        </p>
                    </div>
                </div>
            </div>
