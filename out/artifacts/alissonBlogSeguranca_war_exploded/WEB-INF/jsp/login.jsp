...
<div class="container ">
    ...
    <div class="row">
        ...
        <c:forEach items="${posts}" var="post">
                <div class=" carousel-item col s12 m8 l6 blue ">
                    <h2 class="header">${post.tituloPost}</h2>
    ...
    <div class="fixed-action-btn horizontal click-to-toggle">
        <a class="btn-floating btn-large blue tooltipped" href="todosPosts.html" data-position="left" data-delay="50" data-tooltip="Ver todos os posts"> <i class="material-icons">menu</i></a>
    </div>
    </div>
    </div>
</body>
